...
public class IabHelper {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                purchase = Purchase.fromJson(mPurchasingItemType, dataSignature, purchaseData);
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                if (Security.INSTANCE.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
                    ...
                    Purchase purchase = Purchase.fromJson(itemType, signature, purchaseData);
    ...
    int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus)
        ...
        for (String thisResponse : responseList) {
            SkuDetails d = SkuDetails.fromJson(itemType, thisResponse);
